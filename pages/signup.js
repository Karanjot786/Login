...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    let res = await fetch("https://login-jet-one.vercel.app/api/signup", {
      method: 'POST',
      headers: {
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6" method="POST" >
          ...
          <div className="-space-y-px rounded-md shadow-sm">
            ...
            <div>
              ...
              <input value={phone} onChange={handleChange} id="phone" name="phone" type="text" autoComplete="phone" required className="relative block w-full appearance-none rounded-none rounded-t-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="Enter Phone Number" />
            </div>
            <div>
